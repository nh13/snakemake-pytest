...
run "Unit Tests"     "python -m pytest -vv -r sx src"
run "Style Checking" "black --line-length 99 --check src"
run "Linting"        "flake8 --config=$parent/flake8.cfg src"
run "Type Checking"  "mypy -p src --config $parent/mypy.ini"
